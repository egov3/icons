...
export const Shield = (props: IIcon = iconBaseDefaults) => (
  <svg
    width={props.width}
    height={props.height}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <path
      d="M12.058 8L13.016 10.9482H16.1162L13.6081 12.7704L14.5661 15.7188L12.0581 13.8966L9.55 15.7188L10.508 12.7704L8 10.9482H11.1L12.058 8Z"
      fill="black"
    />
  </svg>
);
